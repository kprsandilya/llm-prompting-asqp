...
cate_list = {
    ...
    "coursera": coursera_aspect_cate_list,
    "hotels": hotels_aspect_cate_list
}

task_data_list = {
    "aste": ["laptop14", "rest14", "rest15", "rest16"],
    "tasd": ['rest15', "rest16", "gerest", "hotels", "coursera"],
    "acos": ['laptop16', "rest16", "flightabsa", "gerest", "hotels", "coursera"],
    "asqp": ['rest15', "rest16", "flightabsa", "gerest", "hotels", "coursera"],
}
force_words = {
    'aste': {
    ...
    'tasd': {
        ...
        "coursera": coursera_aspect_cate_list + list(sentword2opinion.values()) + ['[SSEP]']
    },
    'acos': {
